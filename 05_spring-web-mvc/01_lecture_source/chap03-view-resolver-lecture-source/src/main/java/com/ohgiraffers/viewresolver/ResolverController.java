...
public class ResolverController {
    ...
    //ViewResolver(뷰해석기) 인터페이스를 구현한 ThymleafViewResolver를 이용하고 있다.
    ...
    public ModelAndView modelAndViewTest(ModelAndView mv){
        ...
        mv.addObject("forwardMessage2","ModelAndView를 이용한 모델과 뷰 반환");
        mv.setViewName("result");
        return mv;
    }
    @GetMapping("modelandview-redirect")
    public ModelAndView modelAndViewRedirect(ModelAndView mv){
        mv.addObject("message2","ModleAndView 를 이용한 redirect");
